...
const SignUp = () => {
    ...
    const invalidatePass = () => {
        ...
        passwordInput.classList.add("invalidate")
    }

    const validatePass = () => {
        let passwordInput = document.getElementById("password")
        passwordInput.classList.remove("invalidate")
    }

    const invalidateConfirmPass = () => {
        let confirmPasswordInput = document.getElementById("confirm-password")
        confirmPasswordInput.classList.add("invalidate")
    }

    const validateConfirmPass = () => {
        let confirmPasswordInput = document.getElementById("confirm-password")
        confirmPasswordInput.classList.remove("invalidate")
    }
                    ...
                    <div className="mt-5">
                        ...
                        <div className="grid gap-y-4">
                            ...
                            <div className="relative">
                                <input type="email" id="email" name="email" className="text-input py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required aria-describedby="email-error"/>
                            ...
                            <div>
                            <label htmlFor="password" className="block text-sm mb-2 dark:text-white">Password (&gt;6 characters)</label>
                            <div className="relative">
                                <input onChange={undoPassInvalidations} type="password" id="password" name="password" className="text-input py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required aria-describedby="password-error"/>
                                <div className="hidden absolute inset-y-0 right-0 flex items-center pointer-events-none pr-3">
                                <svg className="h-5 w-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                                </svg>
                            ...
                            <div className="relative">
                                <input onChange={undoPassInvalidations} type="password" id="confirm-password" name="confirm-password" className="text-input py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required aria-describedby="confirm-password-error"/>
                                <div className="hidden absolute inset-y-0 right-0 flex items-center pointer-events-none pr-3">
                                <svg className="h-5 w-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                                </svg>
